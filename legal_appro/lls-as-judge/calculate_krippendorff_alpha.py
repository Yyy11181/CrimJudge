...
def collect_all_score_files():
    score_files = glob("lls-as-judge/llm打分/*.xlsx")
...
def main():
    ...
    # 收集所有打分文件
    score_files = collect_all_score_files()
    
    # 检查文件一致性
    columns_consistent, rows_consistent = check_files_consistency(score_files)
    ...
    # 提取评分数据
    score_data = extract_scores(score_files)
