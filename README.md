# CrimJudge
This benchmark supports periodic evaluation of newly released or updated models in evaluating LLMs in criminal adjudication. 
This is a professional, high-quality English version of your README, optimized for GitHub. It uses clear headings, structured lists, and technical terminology appropriate for the LegalTech and AI research community.
...
│   ├── Single-Defendant-Single-Crime/  # SLJA, CAIL, Judge datasets
│   ├── Single-Defendant-Multi-Crime/   # CAIL, Judge datasets
│   └── Multi-Defendant/                # CMDL, Judge, MultiLJP datasets
│
├── outcome_evaluation/             # Rule-based Evaluation Module
│   ├── calc_[dataset].py           # Evaluation scripts for specific datasets
│   ├── crime_extraction.py         # Accusation extraction logic
│   ├── judge_extraction.py         # Judgment info extraction
...
│   └── generate/                   # Evaluation data generation
│
└── pipeline/                       # Inference & API Pipeline
    ├── request.py                  # Standard API requests (OpenAI, etc.)
    ├── request_yibu.py             # Asynchronous API requests
